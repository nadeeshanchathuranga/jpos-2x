    ...
    <div class="p-6 bg-gray-50">
      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="mb-4 bg-white rounded-xl p-4 shadow-sm border border-gray-200">
          ...
          <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
            ...
            <div class="md:col-span-2">
              ...
              <select
                class="w-full px-3 py-2 text-sm text-gray-800 bg-gray-100 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          ...
          <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
              ...
              <tbody>
                ...
                >
                  <td class="px-4 py-3">
                    <div v-if="product.product_id" class="text-gray-900 font-medium">
                      {{
                        product.product_obj
                  ...
                  <td class="px-4 py-3 text-center">
                    <button
                      type="button"
                      class="px-4 py-2 text-xs font-medium text-white bg-red-600 rounded-full hover:bg-red-700 transition-all duration-200 disabled:opacity-50"
        ...
        <div class="flex justify-end gap-4 mt-6">
          ...
          <button
            type="submit"
            class="px-6 py-2.5 rounded-full font-medium text-sm bg-blue-600 text-white hover:bg-blue-700 transition-all duration-200 disabled:opacity-50"
