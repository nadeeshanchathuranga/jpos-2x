...
<template>
  <Modal :show="open" @close="closeModal" max-width="4xl">
    <div
      class="p-6 bg-gray-50 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
    >
      ...
      <div class="p-4 mb-4 bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <div class="flex gap-3">
          ...
          <button
            @click="printBarcode"
            class="px-6 py-2 text-sm font-semibold text-white bg-green-600 hover:bg-green-700 rounded-lg transition-all duration-200"
          >
      ...
      <div class="space-y-4 text-gray-800">
        ...
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-200">
          ...
          <div
            class="grid grid-cols-1 gap-3 md:grid-cols-3 p-3 bg-gray-50 rounded-lg border border-gray-200 mt-3"
          >
            <div class="p-3 bg-white rounded-lg border border-gray-200">
              <p class="text-xs text-gray-600">
                Store Quantity
          ...
          <div
            class="grid grid-cols-1 md:grid-cols-3 gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200 mt-3"
          >
            <div class="p-3 bg-white rounded-lg border border-gray-200">
