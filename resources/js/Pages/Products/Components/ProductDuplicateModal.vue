<template>
  <Modal :show="open" @close="closeModal" max-width="6xl">
    <div class="p-6 bg-gray-900">
      <h2 class="mb-6 text-2xl font-bold text-white">Duplicate Product</h2>
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <div v-if="displayImage" class="mb-3">
                <img :src="displayImage" alt="Current product image" class="h-24 rounded border border-gray-700 object-cover" />
              </div>
              <input @input="onImageChange" type="file" accept="image/*"
...
const submit = () => {
  ...
  form.transform(() => formData).post(route("products.duplicate", props.product.id), {
    forceFormData: true,
    preserveScroll: true,
    onSuccess: () => {
      closeModal();
