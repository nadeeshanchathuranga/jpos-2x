<template>
  ...
  <div class="space-y-1.5">
    ...
    <textarea
      v-model="form.address"semibold text-gray-700">
      Address
    </label>
    <textarea
  ...
  <!-- Actions -->
  <div class="flex items-center justify-end pt-4 space-x-3 border-t border-gray-300">
    <button
      type="button"
      @click="closeModal"
...
const form = useForm({
  name:Modal from "@/Components/Modal.vue"
const submit = () => {
